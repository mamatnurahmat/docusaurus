...
export default function ProductionQoinhubPage(): React.ReactElement {
    ...
    useEffect(() => {
        fetch('/data/deploy/production-qoinhub.json')
            .then((res) => {
    ...
    return (
        <Layout title="Production Qoinhub" description="Production Qoinhub deployment table">
            <main className={styles.container}>
                <div className={styles.header}>
                    <div>
                        <h1 className={styles.title}>Production Qoinhub Deployments</h1>
                        <p className={styles.subtitle}>
                            Loaded from <code>/data/deploy/production-qoinhub.json</code> · {filtered.length} of {data.length} entries
                        </p>
                    </div>
                    <input
